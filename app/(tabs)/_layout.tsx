...
const TABS: { name: string; icon: IoniconsName; label: string; fab?: true }[] = [
  ...
  { name: 'log',      icon: 'add',                   label: '',        fab: true },
  ...
  return (
    ...
    >
      ...
      <View style={[s.surface, { height: tabBarH, backgroundColor: tabBg }]}>
        ...
        {/* Left border segment */}
        <View style={[s.borderLine, { left: 0, width: leftW, backgroundColor: borderClr }]} />
        ...
        <View style={[s.borderLine, { right: 0, width: leftW, backgroundColor: borderClr }]} />
