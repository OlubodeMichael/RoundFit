...
export default function CycleTrackingScreen() {
  ...
  return (
    <View style={[s.root, { backgroundColor: bg, paddingTop: insets.top + 8 }]}>
      ...
      <Text style={[s.eyebrow, { color: mid }]}>Women&apos;s Health</Text>
      <Text style={[s.title, { color: hi }]}>Cycle Tracking</Text>
      <Text style={[s.sub, { color: mid }]}>
        Log period, current phase, days remaining, next period prediction, and history will live here.
      </Text>
    </View>
  );
}
