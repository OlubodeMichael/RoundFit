...
export default function NotificationsScreen() {
  ...
  return (
    <View style={[s.root, { backgroundColor: bg, paddingTop: insets.top + 8 }]}>
      ...
      <Text style={[s.eyebrow, { color: mid }]}>Preferences</Text>
      <Text style={[s.title, { color: hi }]}>Notifications</Text>
      <Text style={[s.sub, { color: mid }]}>
        Toggles and time pickers for each reminder will live here.
      </Text>
    </View>
  );
}
